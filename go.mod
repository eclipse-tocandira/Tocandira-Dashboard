...
require (
	...
	golang.org/x/oauth2 v0.11.0 // @grafana/grafana-authnz-team
...
require (
	...
	google.golang.org/genproto v0.0.0-20230822172742-b8732ec3820d // indirect; @grafana/backend-platform
)
